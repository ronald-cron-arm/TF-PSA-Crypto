...
#ifndef TF_PSA_CRYPTO_MBEDTLS_CRYPTO_BUILTIN_COMPOSITES_H
#define TF_PSA_CRYPTO_MBEDTLS_CRYPTO_BUILTIN_COMPOSITES_H
...
#endif /* TF_PSA_CRYPTO_MBEDTLS_CRYPTO_BUILTIN_COMPOSITES_H */
